...
public class GroupController {
    ...
    @RequestMapping(value = "/group/all", method = RequestMethod.GET, produces = "application/json; charset=utf-8")
    @ApiOperation(value = "/group/all", notes = "Returns a status")
    ...
    @ApiOperation(value = "/group/{id}", notes = "Returns a status")
